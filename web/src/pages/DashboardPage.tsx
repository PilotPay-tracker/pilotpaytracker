...
function FlightRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_auto] items-center gap-4 py-2.5 border-b border-white/[0.04] last:border-0 group">
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 py-7">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        {/* Recent Flights - takes 2 of 3 columns */}
        <div className="xl:col-span-2 rounded-xl border border-white/[0.06] bg-white/[0.02]">
          ...
          {d?.recentFlights && d.recentFlights.length > 0 ? (
            <div className="px-5 py-2">
              ...
              {d.recentFlights.slice(0, 8).map((flight) => (
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border border-white/[0.06] bg-white/[0.02]">
            ...
            <div className="px-5 py-3">
              <PeriodRow
                label="Block Time"
                value={formatMinutesToHHMM(d?.totalBlockMinutes ?? 0)}
              />
              <PeriodRow
                label="Credit Time"
                value={formatMinutesToHHMM(d?.totalCreditMinutes ?? 0)}
              ...
              {(d?.paidCreditMinutes ?? 0) > 0 && (
                <PeriodRow
                  label="Paid Credit"
                  value={formatMinutesToHHMM(d?.paidCreditMinutes ?? 0)}
                />
              )}
          ...
          {/* Annual Projection (when data available) */}
          {projectedAnnual && (
